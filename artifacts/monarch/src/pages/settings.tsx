...
function ProfilePanel() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h2 className="text-base font-bold text-[#3A3A3A] dark:text-[#003349]">Profile</h2>
        <p className="text-xs text-[#3A3A3A]/50 dark:text-[#003349]/40 mt-0.5">Update your personal details and profile picture.</p>
      </div>

      <div className="p-5 rounded-xl bg-white dark:bg-[#FFFFFF] border border-[#FFBC80]/30 dark:border-[#9BDBF3]/30">
        <p className="text-xs font-semibold text-[#3A3A3A]/55 dark:text-[#003349]/45 uppercase tracking-wider mb-4">Profile Picture</p>
          ...
          <div>
            ...
            {profile.picture && (
              <button onClick={() => saveAvatar(null)} disabled={uploading}
                className="ml-2 px-3 py-1.5 rounded-lg text-xs font-medium text-[#3A3A3A]/55 dark:text-[#003349]/45 hover:bg-[#FFBC80]/10 dark:hover:bg-[#EFBAE1]/10 transition-colors disabled:opacity-50">
                Remove
              </button>
            )}
            <p className="mt-1.5 text-xs text-[#3A3A3A]/40 dark:text-[#003349]/30">JPG, PNG or GIF. Max 5MB.</p>
      ...
      <div className="p-5 rounded-xl bg-white dark:bg-[#FFFFFF] border border-[#FFBC80]/30 dark:border-[#9BDBF3]/30">
        <p className="text-xs font-semibold text-[#3A3A3A]/55 dark:text-[#003349]/45 uppercase tracking-wider mb-4">Personal Details</p>
        <div className="space-y-3">
          <div>
            <label className="block text-xs text-[#3A3A3A]/55 dark:text-[#003349]/45 mb-1">Full Name</label>
            <input type="text" value={name} onChange={(e) => setName(e.target.value)}
              placeholder="Your full name"
              className="w-full px-3 py-2 rounded-lg text-sm bg-[#FFF9F2] dark:bg-[#FFFFFF] text-[#3A3A3A] dark:text-[#003349] border border-[#FFBC80]/50 dark:border-[#9BDBF3]/50 focus:border-[#FFBC80] dark:focus:border-[#9BDBF3] outline-none transition-colors" />
          </div>
          <div>
            <label className="block text-xs text-[#3A3A3A]/55 dark:text-[#003349]/45 mb-1">Title / Role</label>
      ...
      <div className="p-5 rounded-xl bg-white dark:bg-[#FFFFFF] border border-[#FFBC80]/30 dark:border-[#9BDBF3]/30">
        <p className="text-xs font-semibold text-[#3A3A3A]/55 dark:text-[#003349]/45 uppercase tracking-wider mb-3">Sidebar Preview</p>
        <div className="flex items-center gap-3 p-3 rounded-lg bg-[#FFBC80]/8 dark:bg-[#EFBAE1]/8">
          ...
          <div>
            <div className="text-sm font-semibold text-[#3A3A3A] dark:text-[#003349]">{name || "Your Name"}</div>
            <div className="text-xs text-[#3A3A3A]/50 dark:text-[#003349]/40">{title || "Your Title"}</div>
          </div>
        </div>
      </div>
    </div>
...
function AppearancePanel() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h2 className="text-base font-bold text-[#3A3A3A] dark:text-[#003349]">Appearance</h2>
        <p className="text-xs text-[#3A3A3A]/50 dark:text-[#003349]/40 mt-0.5">Choose your preferred color theme.</p>
      </div>

      <div className="p-5 rounded-xl bg-white border border-[#FFBC80]/30 dark:border-[#9BDBF3]/30">
        <p className="text-xs font-semibold text-[#3A3A3A]/55 dark:text-[#003349]/45 uppercase tracking-wider mb-4">Color Theme</p>
        <div className="grid grid-cols-2 gap-3">
          ...
          <button
            ...
            className="relative p-4 rounded-xl border-2 transition-all text-left"
            style={{
              borderColor: theme === "dark" ? "#BFA1E3" : "transparent",
              background: theme === "dark"
                ? "linear-gradient(135deg, rgba(191,161,227,0.18), rgba(155,219,243,0.18))"
                : "rgba(191,161,227,0.05)",
            }}
          >
            ...
            <div className="mt-2 space-y-1.5">
              <div className="h-1.5 rounded-full bg-[#BFA1E3]/60 w-full" />
              <div className="h-1.5 rounded-full bg-[#9BDBF3]/50 w-3/4" />
            </div>
          </button>
        </div>
      </div>
...
function ApiKeysPanel() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h2 className="text-base font-bold text-[#3A3A3A] dark:text-[#003349]">API Keys</h2>
        <p className="text-xs text-[#3A3A3A]/50 dark:text-[#003349]/40 mt-0.5">Generate and manage API keys for programmatic access to your organization's data.</p>
      </div>

      {/* Generate Key */}
      <div className="p-5 rounded-xl bg-white dark:bg-[#FFFFFF] border border-[#FFBC80]/30 dark:border-[#9BDBF3]/30">
        <p className="text-xs font-semibold text-[#3A3A3A]/55 dark:text-[#003349]/45 uppercase tracking-wider mb-4">Generate New Key</p>
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-3 py-2 rounded-lg text-sm bg-[#FFF9F2] dark:bg-[#FFFFFF] text-[#3A3A3A] dark:text-[#003349] border border-[#FFBC80]/50 dark:border-[#9BDBF3]/50 focus:border-[#FFBC80] dark:focus:border-[#9BDBF3] outline-none transition-colors placeholder-[#3A3A3A]/35 dark:placeholder-[#003349]/25"
          />
          <button
      ...
      {/* Active Keys */}
      <div className="p-5 rounded-xl bg-white dark:bg-[#FFFFFF] border border-[#FFBC80]/30 dark:border-[#9BDBF3]/30">
        <p className="text-xs font-semibold text-[#3A3A3A]/55 dark:text-[#003349]/45 uppercase tracking-wider mb-4">Active Keys</p>
        {keys.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-8 gap-2">
            <KeyRound size={24} className="text-[#FFBC80]/40 dark:text-[#BFA1E3]/40" />
            <p className="text-xs text-[#3A3A3A]/40 dark:text-[#003349]/30">No API keys yet. Generate one above.</p>
          </div>
        ) : (
          <div className="space-y-3">
            {keys.map((k) => (
              <div key={k.id} className="rounded-lg border border-[#FFBC80]/20 dark:border-[#9BDBF3]/20 bg-[#FFF9F2] dark:bg-[#FFFFFF] p-3.5">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <span className="text-sm font-semibold text-[#3A3A3A] dark:text-[#003349]">{k.label}</span>
                    {k.isNew && (
                  ...
                  <span className="text-[10px] text-[#3A3A3A]/40 dark:text-[#003349]/30">Created {k.createdAt}</span>
                </div>
                <div className="flex items-center gap-2">
                  <code className="flex-1 text-xs font-mono text-[#3A3A3A]/70 dark:text-[#003349]/55 truncate">
                    {revealed[k.id] ? k.key : maskKey(k.key)}
                  </code>
                  <button
                    onClick={() => setRevealed((prev) => ({ ...prev, [k.id]: !prev[k.id] }))}
                    className="p-1.5 rounded-md text-[#3A3A3A]/40 dark:text-[#003349]/30 hover:text-[#FFBC80] dark:hover:text-[#BFA1E3] hover:bg-[#FFBC80]/10 dark:hover:bg-[#EFBAE1]/10 transition-colors"
                  ...
                  <button
                    ...
                    title="Copy key"
                  >
                    {copied === k.id ? <Check size={13} className="text-[#FFBC80] dark:text-[#BFA1E3]" /> : <Copy size={13} />}
                  </button>
                  <button
                    onClick={() => handleRevoke(k.id)}
                    className="p-1.5 rounded-md text-[#3A3A3A]/40 dark:text-[#003349]/30 hover:text-red-500 hover:bg-red-500/10 transition-colors"
                    title="Revoke key"
                  >
                    <Trash2 size={13} />
                  </button>
      ...
      {/* Security Guide */}
      <div className="p-5 rounded-xl border border-[#FFBC80]/40 dark:border-[#9BDBF3]/40 bg-[#FFBC80]/5 dark:bg-[#BFA1E3]/8">
        <div className="flex items-center gap-2 mb-2.5">
          <ShieldAlert size={15} className="text-[#FFBC80] dark:text-[#BFA1E3] shrink-0" />
          <p className="text-xs font-bold text-[#3A3A3A] dark:text-[#003349] uppercase tracking-wider">API Key Security</p>
        </div>
        <p className="text-xs text-[#3A3A3A]/60 dark:text-[#003349]/50 leading-relaxed">
...
function PlaceholderPanel({ label, desc }: { label: string; desc: string }) {
  return (
    <div className="space-y-5">
      <div>
        <h2 className="text-base font-bold text-[#3A3A3A] dark:text-[#003349]">{label}</h2>
        <p className="text-xs text-[#3A3A3A]/50 dark:text-[#003349]/40 mt-0.5">{desc}</p>
      </div>
      <div className="p-10 rounded-xl bg-white dark:bg-[#FFFFFF] border border-[#FFBC80]/30 dark:border-[#9BDBF3]/30 flex flex-col items-center justify-center gap-3">
        <SettingsIcon size={28} className="text-[#FFBC80]/50 dark:text-[#BFA1E3]/50" />
        <p className="text-sm text-[#3A3A3A]/45 dark:text-[#003349]/35">{label} configuration coming soon.</p>
      </div>
    </div>
  );
}
...
function ReadOnlyBanner() {
  return (
    <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#FFBC80]/10 dark:bg-[#EFBAE1]/10 border border-[#FFBC80]/30 dark:border-[#9BDBF3]/30 mb-5">
      <Lock size={13} className="text-[#FFBC80] dark:text-[#BFA1E3] shrink-0" />
      <p className="text-xs text-[#3A3A3A]/60 dark:text-[#003349]/45">
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#FFF9F2] dark:bg-white">
      ...
      <div className="w-52 shrink-0 border-r border-[#FFBC80]/25 dark:border-[#9BDBF3]/25 pt-6 pb-4 px-2 bg-[#FFF9F2] dark:bg-white overflow-y-auto">
        <p className="px-3 mb-2 text-[10px] font-bold tracking-widest text-[#3A3A3A]/40 dark:text-[#003349]/30 uppercase">Settings</p>
              ...
              <button
                ...
                className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 cursor-pointer ${
                  active
                    ...
                    : "text-[#3A3A3A]/55 dark:text-[#003349]/45 hover:text-[#3A3A3A] dark:hover:text-[#003349] hover:bg-[#FFBC80]/10 dark:hover:bg-[#EFBAE1]/10"
                }`}
