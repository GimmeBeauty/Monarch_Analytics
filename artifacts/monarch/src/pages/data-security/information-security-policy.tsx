  ...
  return (
    <div className="min-h-screen bg-[#FFF9F2] dark:bg-[#FFFFFF] flex flex-col">
      ...
      <div className="flex-1 max-w-2xl mx-auto w-full px-8 py-12">
        <div className="mb-10">
          <h1 className="text-3xl font-bold text-[#3A3A3A] dark:text-[#003349] mb-2">Information Security Policy</h1>
          <p className="text-sm text-[#3A3A3A]/50 dark:text-[#003349]/40">Last updated: May 2026 · Durham Brands</p>
                  ...
                  <div key={item.heading}>
                    ...
                    {item.list && (
                      <ul className="space-y-1.5 mt-1">
                        {item.list.map((li, i) => (
                          <li key={i} className="flex gap-2 text-sm text-[#3A3A3A]/65 dark:text-[#003349]/55 leading-relaxed">
