...
export default function Overview() {
  ...
  const data = useMemo(() => {
    ...
    const kpis: KPIMetric[] = [
      ...
      { id: "orders",  label: "Orders",             value: apiData.orders,   formatted: apiData.orders.toLocaleString(), change: 0, positive: true, format: "number",  description: "Total orders from all selected stores" },
