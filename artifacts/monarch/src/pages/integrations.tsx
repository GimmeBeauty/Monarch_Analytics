...
function ShopifyModal({ onClose }: { onClose: () => void }) {
  ...
  const handleConnect = () => {
    ...
    // Navigate to the OAuth initiation endpoint — the server will redirect to Shopify
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-sm rounded-2xl p-6 monarch-card-settings">
        ...
        {error && (
          <p className="flex items-center gap-1.5 text-xs text-red-500 mt-1.5 mb-0">
...
export default function Integrations() {
  ...
  // Handle success/error query params from OAuth callback redirect
  useEffect(() => {
