    ...
    <AuthShell>
      {stage === "loading" && (
        <div className="text-center py-8">
          ...
          <p className="text-sm text-[#3A3A3A]/50 dark:text-[#003349]/40">Verifying reset link…</p>
        </div>
      )}
      ...
      {stage === "form" && (
        <>
          <button
            type="button"
            onClick={() => setLocation("/login")}
            className="flex items-center gap-1.5 text-xs text-[#3A3A3A]/45 dark:text-[#003349]/35 hover:text-[#3A3A3A]/70 mb-5 transition-colors"
          >
          ...
          <p className="text-xs text-[#3A3A3A]/50 dark:text-[#003349]/40 mb-6">
            Resetting password for <span className="font-medium text-[#3A3A3A]/70 dark:text-[#003349]/60">{email}</span>
          </p>
