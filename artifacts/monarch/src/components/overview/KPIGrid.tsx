    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-1.5 min-w-0">
          <span className="text-xs font-medium text-[#3A3A3A]/55 dark:text-[#003349]/45 uppercase tracking-wider leading-none truncate">
            {kpi.label}
          </span>
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs text-[#3A3A3A]/40 dark:text-[#003349]/30">vs prior</span>
      </div>
