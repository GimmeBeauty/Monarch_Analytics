...
function CustomTooltip({ active, payload, label, metric }: TooltipProps<number, string> & { metric: Metric }) {
  ...
  if (metric === "both") {
    ...
    return (
      <div className="rounded-xl border border-[#FFBC80]/30 dark:border-[#9BDBF3]/30 bg-white/95 dark:bg-[#FFFFFF]/95 backdrop-blur-sm shadow-lg px-3 py-2.5">
        <p className="text-xs text-[#3A3A3A]/50 dark:text-[#003349]/40 mb-1">{label}</p>
        <p className="text-sm font-bold text-[#3A3A3A] dark:text-[#003349]">
  ...
  return (
    <div className="rounded-xl border border-[#FFBC80]/30 bg-white/95 dark:bg-[#FFFFFF]/95 backdrop-blur-sm shadow-lg px-3 py-2.5">
      <p className="text-xs text-[#3A3A3A]/50 dark:text-[#003349]/40 mb-1">{label}</p>
      <p className="text-sm font-bold text-[#3A3A3A] dark:text-[#003349]">
